...
const ERROR_TRANSLATIONS = {
  ...
  'Vote campaign can only be edited while it is in draft': 'Chỉ có thể chỉnh sửa Phiên Vote khi đang ở bản nháp.',
  'At least one vote category is required': 'Cần có ít nhất một hạng mục bình chọn.',
  'Vote campaign title is required': 'Tiêu đề Phiên Vote không được để trống.',
  'Vote campaign title must be a valid text up to 200 characters': 'Tiêu đề Phiên Vote phải là văn bản và không quá 200 ký tự.',
  'Vote campaign description must be text up to 1000 characters': 'Mô tả Phiên Vote phải là văn bản và không quá 1.000 ký tự.',
  'Vote campaign deletion is temporarily unavailable': 'Hiện chưa thể xóa Phiên Vote. Vui lòng thử lại sau.',
  ...
  'A closed vote campaign cannot be reopened': 'Phiên Vote đã đóng không thể mở lại.',
  ...
  'Vote campaign must be open before it can be closed': 'Phiên Vote phải được mở trước khi đóng.',
  'Vote campaign is no longer in draft': 'Phiên Vote không còn ở trạng thái bản nháp.',
...
const SUCCESS_TRANSLATIONS = {
  ...
  'Vote campaign updated successfully': 'Cập nhật Phiên Vote thành công.',
  'Vote campaign created successfully': 'Tạo Phiên Vote thành công.',
  'Vote campaign opened successfully': 'Mở Phiên Vote thành công.',
  'Vote close time updated successfully': 'Cập nhật thời điểm đóng thành công.',
  'Vote campaign closed successfully': 'Đóng Phiên Vote thành công.',
  'Vote campaign deleted successfully': 'Xóa Phiên Vote và toàn bộ lượt vote thành công.',
  'Registration successful': 'Đăng ký thành công.',
  'Registration cancelled': 'Hủy đăng ký thành công.',

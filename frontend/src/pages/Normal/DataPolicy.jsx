...
export default function DataPolicy() { const { t } = useTranslation(); return <PolicyPage icon={<Database />} eyebrow={t("normal.policy.dataEyebrow")} title={t("normal.policy.dataTitle")} intro={t("normal.policy.dataIntro")} sections={t("normal.policy.dataSections", { returnObjects: true })} note={t("normal.policy.dataNote")} />; }

---
name: code-review
description: "Review code để phát hiện bug, lỗi bảo mật, vấn đề hiệu năng và các điểm cần cải thiện. Dùng khi người dùng yêu cầu code review hoặc kiểm tra chất lượng mã nguồn."
---

---
name: review-ui
description: "Review UI/UX, responsive design, accessibility và tính nhất quán về CSS cho các trang hoặc component frontend. Dùng khi người dùng yêu cầu review UI, responsive hoặc giao diện."
---
